// Construye las variables de productSet para cada ficha de la tanda de 20
// y comprueba ANTES de enviarlas que todo cuadra. Regla de Pablo: probar
// primero, subir despues.
const fs = require('fs');
const path = require('path');
const { COL, fichas } = require('./tanda20-datos');

const CJ = require('/tmp/claude-0/-home-user-libre/917f3732-f020-5fa4-b126-7adc8cf2b4f6/scratchpad/fichas20.json');
const SALIDA = '/tmp/claude-0/-home-user-libre/917f3732-f020-5fa4-b126-7adc8cf2b4f6/scratchpad/tanda20-vars';
...
for (const f of fichas) {
  ...
  if (!cj) { fallos.push(`${f.clave}: no esta en fichas20.json`); continue; }
